    ...
    <div class="content-wrapper col-md-12 col-lg-12">
        <div class="container bg-white shadow rounded p-2">
                ...
                <form action="" method="POST" class="d-flex flex-wrap align-items-center" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4 col-sm-12 mb-3 d-flex flex-column">
                        ...
                        <button class="btn btn-text btn-dark" name="submit">
                            <i class="ti-upload btn-icon-prepend pr-2"></i>Upload</span>
                        </button>
                    </div>
            ...
            if (isset($_POST['submit'])) {
                ...
                $add = mysqli_query($conn, "INSERT INTO syllabus SET  category_id = '$category_id', sub_category_id = '$sub_category_id' , subject_id = '$subject_id', title = '$title' , description = '$description' , status = '$status'");
            }
            ?>
        </div>
    </div>
        ...
        async function deletecategories(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const request = await fetch('delete/deletesyllabus.php', {
                        method: "POST",
                        header: {
